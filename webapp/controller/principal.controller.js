sap.ui.define([
	...
	return Controller.extend("AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.controller.principal", {
		onInit: function () {
			t = this;
			oView = this.getView();
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		EnvioCorreo: function (evt) {
			...
			if (!oDialog) {
				...
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.view.Correo", this);
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		popCarga: function () {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.view.PopUp", this);
				oView.addDependent(oDialog);
			}
			oDialog.open();
		...
		popSuccesCorreo: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.view.SuccesCorreo", this); //aqui se debe cambiar ar_dp_rep
				oView.addDependent(oDialog);
			}
		...
		popConfirmacion: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.view.Confirmacion", this); //aqui se debe cambiar ar_dp_rep
				oView.addDependent(oDialog);
			}
...
console.log(flagestado);
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		popVINsi: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.view.ingresoVINsi", this); //aqui se debe cambiar ar_dp_rep
				oView.addDependent(oDialog);
			}
		...
		popVINno: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDOSREPORTE_EXPO.AR_DP_REP_PEDIDOSREPORTE_EXPO.view.ingresoVINno", this); //aqui se debe cambiar ar_dp_rep
				oView.addDependent(oDialog);
			}
